...
const routes: Routes = [
    ...
    // Dashboard layout pages: Summary, Parameters, Data Log, Run Tests, Schedule, Notifications
    {
        ...
        children: [
            {
                path: "my-devices/device-name/summary",
                component: SummaryComponent,
            },
            {
                path: "my-devices/device-name/parameters",
                component: ParametersComponent,
            },
            {
                path: "my-devices/device-name/parameters/data-log",
                component: DataLogComponent,
            },
            {
                path: "my-devices/device-name/run-tests",
                component: RuntestsComponent,
            },
            {
                path: "my-devices/device-name/schedule",
                component: ScheduleComponent,
            },
            {
                path: "my-devices/device-name/notifications",
